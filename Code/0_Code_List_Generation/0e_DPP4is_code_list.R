...
# 
# Final Outputs:
# 1) Code_Lists/DPP4is/Aurum_DPP4is_codelist_20250614.txt: Updated Aurum DPP4is code list
# 2) Code_Lists/DPP4is/Gold_DPP4is_codelist_20250614.txt: Updated GOLD DPP4is code list
# ==============================================================================
...
#             file = paste0(wd, path_output, "Aurum_DPP4is_codelist_20250621.txt"),
#             sep = "\t", row.names = FALSE)
...
#             file = paste0(wd, path_output, "Gold_DPP4is_codelist_20250621.txt"),
#             sep = "\t", row.names = FALSE)
