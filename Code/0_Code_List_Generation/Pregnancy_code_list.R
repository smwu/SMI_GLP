...
filter(grepl(paste0("(?i)hyperemesis|antenatal|
ante-natal|serum pregnancy test positive|urine pregnancy test positive",

# Mid pregnancy (no specific mid pregnancy codes)


# Late pregnancy
"polyhydramnios|oligohydramnios|amniotic|placenta|
antepartum",

# Post natal 
"labour|post-partum|delivery|puerperal|
puerperium|postpartum|childbirth|postnatal|post-natal",

# Unspecified 
"pregnancy","gestation|pregnant|maternal care|
primigravida|multigravida|obstetric|pregnant"),
...
# Negations 
  ...
  unspecified whether in pregnancy|non obstetric|unspec whether during|
  no history of ectopic pregnancy|	
  pregnancy prevention programme|recurrent pregnancy loss, not pregnant|not|
  pregnancy test negative|pregnancy prevention|pregnancy not yet confirmed|
  no history of|urine pregnancy test negative", "test negative","pregnancy test negative",
