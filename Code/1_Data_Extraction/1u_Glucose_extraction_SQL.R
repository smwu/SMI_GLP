# ==============================================================================
# Extract patients with Glucose lab information using code lists (SQL Version)
# Author: SM Wu
...
#
# Inputs:
# 1) ~/SMI_GLP/Code_Lists/Glucose/Aurum_Glucose_codelist_20260206.txt: Updated Aurum glucose code list
# 2) ~/SMI_GLP/Code_Lists/Glucose/Gold_Glucose_codelist_20260206.txt: Updated GOLD glucose code list
...
# 1) ~/SMI_GLP/Data/Extraction_Files/pat_glucose_gold.RData: GOLD patient files for glucose diagnosis
# 2) ~/SMI_GLP/Data/Extraction_Files/pat_glucose_aurum.RData: Aurum patient files for glucose diagnosis
# 
# Final Outputs:
# 1) ~/SMI_GLP/Data/Extraction_Files/pat_glucose_comb.RData: Combined GOLD and Aurum patient files for glucose diagnosis
